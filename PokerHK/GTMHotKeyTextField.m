...
+ (NSString *)stringForKeycode:(UInt16)keycode 
  ...
  switch (keycode) {
      ...
      // Arrow keys
	  case 123: key = NSLeftArrowFunctionKey; localKey = 0x2190; localizedKey = [NSString stringWithCharacters:&localKey length:1]; break;
    case 124: key = NSRightArrowFunctionKey; localKey = 0x2192; localizedKey = [NSString stringWithCharacters:&localKey length:1]; break;
    case 125: key = NSDownArrowFunctionKey; localKey = 0x2193; localizedKey = [NSString stringWithCharacters:&localKey length:1]; break;
    case 126: key = NSUpArrowFunctionKey; localKey = 0x2191; localizedKey = [NSString stringWithCharacters:&localKey length:1]; break;
...
-(void)awakeFromNib
{
	// We fake a notification here, so that the defaults will be picked up by our disptch controller.
